...
import { ForgotPasswordCommand, ResetPasswordCommand, SwitchOrganizationCommand, UpdatePasswordCommand, UserLoginCommand } from '../auth.commands';
...
export class AuthController {
  ...
  async getUserInfo(@Param('tenantId')tenantId:string,@userInfo() user: UserInfo) {
